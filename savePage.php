...
$keepjs = false;
$compress = true;
    //Remove sentences from array summary over specified number characters
...
//Original contents html modification
//Wikipedia
if (strpos( $url, 'wiki')) {
    ...
    $orihtml->find('#mw-head-base',0)->innertext='<div class="mw-stack clickableBigger" style="  box-sizing:border-box;float:right; clear:right; "  onclick="window.location.href = \'summarized.html\'">
                                                                <!--  <button class="" type="button" style="border-radius:0;">--> <a class="btn btn-secondary btn-lg btnSwitch" style="border-radius: .3rem; text-decoration: none" href="summarized.html"><h4 style="font-size: 100%; color: white;">Go summarized page</h4></a> 
                                                                  </div>';
    }
}   //KidsNews
    else if(strpos($url,'kidsnews')){
