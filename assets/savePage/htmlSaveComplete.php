...
require_once 'content_extractor.php'; # class to extract "main" content part of given page
require_once 'url_to_absolute.php'; # or implement your own function to convert relative URLs to absolute
...
class htmlSaveComplete
{
     ...
     * @param bool $compress - whether to remove extra whitespace
     *
     * @return string|void
     */
    public function getCompletePage($keepjs = FALSE, $contentOnly = FALSE, $compress = FALSE)
    {
        ...
        # finally join the css and html and inssert information header
